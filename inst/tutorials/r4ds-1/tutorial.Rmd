...
<!-- DK: Change this knowledge drop to just tell me the  most important things to know about theme(). -->
...
<!-- DK: Question which forces student to use show_col_types = FALSE argument to read_csv(). -->
