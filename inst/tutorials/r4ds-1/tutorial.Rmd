...
Since we have already loaded **tidyverse**, we have therefore loaded **tidyr**, one of the component packages of the "core" *Tidyverse*. Type `billboard` into the Console.
...
Provide a tibble of `billboard` for AI to reference.

Ask AI: Create a simple graph plotting `wk1` against `wk2`. Specify to the AI to only use the functions `ggplot()`, `aes()`, and `geom_point()`. 

Copy and paste this code into a new code chunk with your QMD. Place your cursor on the line of code and run `Cmd/Ctrl + Enter`.
