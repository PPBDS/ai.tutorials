...
Since we have already loaded **tidyverse**, we have therefore loaded **tidyr** and **ggplot2**, some of the component packages of the "core" *Tidyverse*. 
