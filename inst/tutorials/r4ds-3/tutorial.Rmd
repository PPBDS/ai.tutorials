...
Create a Github repo called `analysis`. Make sure to click the 
...
title -- `"Analyzing Baby Names and Flights"` -- and an author (you). Render the document 
and save it as `analysis.qmd`.

Create a `.gitignore` file with `analysis_files` on the first 
