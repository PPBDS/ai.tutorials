...
<!-- SG: Should we have them ask AI or just copy paste-->
...
To stay up to date with us, use our code:
```{r, echo=TRUE}
download.file(
...
<!-- SG: logical vectors knowledge drop -->
...
<!-- SG: knowledge drop, maybe about the sql equivalent-->
