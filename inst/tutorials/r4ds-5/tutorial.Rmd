...
filter(year >= 1990, year <= 2010) |>
 ggplot(aes(x = year, y = rating)) +
  geom_point(aes(size = number/1000, color = rating_category), 
  ...
  scale_color_manual(name = "Rating Category",
                    values = c("Masterpiece (9.0+)" = "#FFD700",
                              "Excellent (8.5-8.9)" = "#4169E1", 
                              "Great (8.0-8.4)" = "#DC143C",
                              "Good (<8.0)" = "#708090")) +
