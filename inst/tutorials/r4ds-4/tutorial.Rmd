---
title: "XX ADD TITLE"
author: "XX Your Name Here"
tutorial:
  id: "XX ADD ID, which should be the same as the directory in which this tutorial is located"
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
<!-- XX: The first Exercise or two are in a Section often involved in getting the data for the tutorial. You must download the data into the `data` directory, obviously.  -->


### Exercise 2

<!-- XX: The meet of a Section generally involves asking AI to create a pipe which accomplishes some goal. -->
...
```{r, echo = TRUE}
# x <- ... where the ellipsis are replaced with
```
