...
Ask AI how to read a `.xlsx` spreadsheet called `data/wine.xlsx` using `read_excel()`. Add this code to a new code chunk in your QMD. Place your cursor at the beginning of the line and run `Cmd/Ctrl + Enter`. Type `wine` in the Console to retrieve the contents of `wine`.
...
<!-- DK: Default is `Cmd/Ctrl + Enter` followed by CP/CR. -->
...
<!-- DK: If you don't understand a knowledge drop, then it is a bad knowledge drop. -->
...
<!-- DK: Nit xw but wine_tibble or wine_data or just wine. -->
